...
?>
    ...
    <main class="contenedor seccion contenido-centrado">
        <h1>Consejos para tener una Piscina en tu Casa sin Gastar Demasiado</h1>

        <div class="entrada-contenedor">
            <picture>
                <source srcset="build/img/blog2.webp" type="image/webp">
                <source srcset="build/img/blog2.jpg" type="image/jpeg">
                <img loading="lazy" src="build/img/blog2.jpg" alt="Blog Entrada">
            </picture>
            ...
            <div class="entrada-contenido">
                ...
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit excepturi vero explicabo, commodi asperiores alias non officiis assumenda maiores, facere aspernatur quia quaerat libero dicta eius molestias dolores, quisquam blanditiis? Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis dignissimos deleniti temporibus vel quasi eos expedita commodi nam deserunt ea, id cum autem nemo ut ab dolorem error fuga blanditiis.
                </p>
            </div>
        </div>
    </main>
